...
export const REGISTER_RESEND_OTP_URL = `${API_URL}/resendOtpCreateAccount/verify-otp`;
...
export const RESEND_LOGIN_OTP_URL = `${API_URL}/resend-login-otp`
...
export const WITHDRAW_INITIATE_URL_ACTIONS = `${API_URL}/dividends/withdrawActions/initiate`;
export const WITHDRAW_CONFIRM_URL_ACTIONS= `${API_URL}/dividends/withdrawActions/confirm`;
export const WITHDRAW_INITIATE_URL_PROJECTS = `${API_URL}/dividends/withdrawProjects/initiate`;
export const WITHDRAW_CONFIRM_URL_PROJECTS= `${API_URL}/dividends/withdrawProjects/confirm`;
